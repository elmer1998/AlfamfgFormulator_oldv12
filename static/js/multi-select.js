function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
    ...
    var m = new DOMParser;
    var targetContainer = document.getElementById("selected-items-container");
    ...
    function g(e, t, l = !1) {
        ...
        t && e.label.toLowerCase().startsWith(t.toLowerCase()) ? p.appendChild(n) : t || p.appendChild(n);
    ...
    function E(e = !0) {
        selected_values = [];
        for (var a = 0; a < n.length; a++) l.options[a].selected = n[a].selected, n[a].selected && selected_values.push({ label: n[a].label, value: n[a].value });
        e && t.hasOwnProperty("onChange") && t.onChange(selected_values);
    }

    l = document.getElementById(e), function () {
